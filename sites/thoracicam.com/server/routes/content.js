const withContent = require('@ascend-media/package-global-monorail/middleware/with-content');
const queryFragment = require('@parameter1/base-cms-marko-web-theme-monorail/graphql/fragments/content-page');
const contact = require('@ascend-media/package-global-monorail/templates/content/contact');
